    ...
    (props2 = {}, _ref = null) => {
      return {
        ...
        className: slots.trigger({
          ...
          isDropdownDisabled: !!(props2 == null ? void 0 : props2.isDisabled)
        }),
...
var PopoverTrigger = (0, import_system3.forwardRef)((props, _) => {
  ...
  const { onPress, ...restProps } = (0, import_react5.useMemo)(() => {
  ...
  const isDisabled = !!(restProps == null ? void 0 : restProps.isDisabled);
  const isNextUIElement = (0, import_system3.isNextUIEl)(child);
  return (0, import_react5.cloneElement)(
    child,
    (0, import_utils3.mergeProps)(
      (0, import_react_utils3.filterDOMProps)(restProps, {
